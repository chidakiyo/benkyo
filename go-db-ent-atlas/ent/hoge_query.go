...
func (hq *HogeQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (hq *HogeQuery) FirstIDX(ctx context.Context) string {
...
func (hq *HogeQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (hq *HogeQuery) OnlyIDX(ctx context.Context) string {
...
func (hq *HogeQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
...
func (hq *HogeQuery) IDsX(ctx context.Context) []string {
	ids, err := hq.IDs(ctx)
	if err != nil {
		panic(err)
	}
